...
class AlertDialogConfig extends ComponentConfig {
  ...
  factory AlertDialogConfig.fromMap(Map<String, dynamic> map) {
    return AlertDialogConfig(
      ...
      actionsAlignment: ThemeDecoder.decodeMainAxisAlignment(map['actionsAlignment']),
      ...
      actionsOverflowDirection: ThemeDecoder.decodeVerticalDirection(map['actionsOverflowDirection']),
      actionsPadding: ThemeDecoder.decodeEdgeInsetsGeometry(map['actionsPadding']),
      buttonPadding: ThemeDecoder.decodeEdgeInsetsGeometry(map['buttonPadding']),
      contentPadding: ThemeDecoder.decodeEdgeInsetsGeometry(map['contentPadding']),
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'actionsAlignment': ThemeEncoder.encodeMainAxisAlignment(actionsAlignment),
      'clipBehavior': ThemeEncoder.encodeClip(clipBehavior),
      'actionsOverflowButtonSpacing': actionsOverflowButtonSpacing,
      'actionsOverflowDirection': ThemeEncoder.encodeVerticalDirection(actionsOverflowDirection),
      'actionsPadding': ThemeEncoder.encodeEdgeInsetsGeometry(actionsPadding as EdgeInsets?),
      'buttonPadding': ThemeEncoder.encodeEdgeInsetsGeometry(buttonPadding as EdgeInsets?),
      'contentPadding': ThemeEncoder.encodeEdgeInsetsGeometry(contentPadding as EdgeInsets?),
      'contentTextStyle': ThemeEncoder.encodeTextStyle(contentTextStyle),
      'iconColor': ThemeEncoder.encodeColor(iconColor),
      'iconPadding': ThemeEncoder.encodeEdgeInsetsGeometry(iconPadding as EdgeInsets?),
      'insetPadding': ThemeEncoder.encodeEdgeInsetsGeometry(insetPadding as EdgeInsets?),
      'titlePadding': ThemeEncoder.encodeEdgeInsetsGeometry(titlePadding as EdgeInsets?),
    };
  }
